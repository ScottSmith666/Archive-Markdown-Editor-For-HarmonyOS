define("vs/monaco.contribution-Cf4oJ-Nv", ["require", "exports", "./editor-DJILDtaA"], (function(require, exports, editor) {
  "use strict";
  ...
  function getMode() {
    return new Promise((resolve, reject) => require(["./htmlMode-RxZOXjWl"], resolve, reject));
  }
