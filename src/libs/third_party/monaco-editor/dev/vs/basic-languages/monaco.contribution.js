define("vs/basic-languages/monaco.contribution", ["require", "../editor-DJILDtaA"], (function(require, editor) {
  "use strict";
  ...
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../freemarker2-QGWehJQP"], resolve, reject)).then((m) => m.TagAutoInterpolationDollar);
    }
  });
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../freemarker2-QGWehJQP"], resolve, reject)).then((m) => m.TagAngleInterpolationDollar);
    }
  });
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../freemarker2-QGWehJQP"], resolve, reject)).then((m) => m.TagBracketInterpolationDollar);
    }
  });
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../freemarker2-QGWehJQP"], resolve, reject)).then((m) => m.TagAngleInterpolationBracket);
    }
  });
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../freemarker2-QGWehJQP"], resolve, reject)).then((m) => m.TagBracketInterpolationBracket);
    }
  });
  registerLanguage({
  ...
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../freemarker2-QGWehJQP"], resolve, reject)).then((m) => m.TagAutoInterpolationBracket);
    }
  });
  registerLanguage({
    id: "go",
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../handlebars-Cbejm_90"], resolve, reject))
  });
  registerLanguage({
    id: "hcl",
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../html-BC9v3bD-"], resolve, reject))
  });
  registerLanguage({
    id: "ini",
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../javascript-B0LkJlEH"], resolve, reject))
  });
  registerLanguage({
    id: "julia",
    extensions: [".jl"],
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../liquid-CQojtkv8"], resolve, reject))
  });
  registerLanguage({
    id: "m3",
  ...
  registerLanguage({
    ...
    extensions: [".mdx"],
    aliases: ["MDX", "mdx"],
    loader: () => new Promise((resolve, reject) => require(["../mdx-Dctwt4sP"], resolve, reject))
  });
  registerLanguage({
    id: "mips",
    extensions: [".s"],
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../python-D4bSYnLZ"], resolve, reject))
  });
  registerLanguage({
    id: "qsharp",
    extensions: [".qs"],
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../razor-DfHJuiV2"], resolve, reject))
  });
  registerLanguage({
    id: "redis",
    extensions: [".redis"],
  ...
  registerLanguage({
    ...
    loader: () => {
      return new Promise((resolve, reject) => require(["../typescript-wvIQBcDW"], resolve, reject));
    }
  });
  registerLanguage({
    id: "typespec",
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../xml-DH9KRJjX"], resolve, reject))
  });
  registerLanguage({
    id: "yaml",
    extensions: [".yaml", ".yml"],
    ...
    loader: () => new Promise((resolve, reject) => require(["../yaml-D5pNIGjN"], resolve, reject))
  });
}));
