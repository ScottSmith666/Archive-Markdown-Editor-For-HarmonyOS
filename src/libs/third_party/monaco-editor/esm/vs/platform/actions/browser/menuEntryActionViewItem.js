    ...
    updateLabel() {
        ...
        if (this.label) {
            ...
            if (this._options?.conversational) {
                this.label.textContent = localize(1666, '{1} to {0}', this._action.label, kb2);
            }
            else {
                this.label.textContent = localize(1667, '{0} ({1})', this._action.label, kb2);
            }
        }
    }
