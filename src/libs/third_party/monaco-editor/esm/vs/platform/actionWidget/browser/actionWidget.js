import { addDisposableListener, EventType, trackFocus, getActiveElement, $ } from '../../../base/browser/dom.js';
...
registerColor('actionBar.toggledBackground', inputActiveOptionBackground, localize(1676, 'Background color for toggled action items in action bar.'));
const ActionWidgetContextKeys = {
    Visible: new RawContextKey('codeActionMenuVisible', false, localize(1677, "Whether the action widget list is visible"))
};
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1678, "Hide action widget"),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1679, "Select previous action"),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1680, "Select next action"),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1681, "Accept selected action"),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1682, "Preview selected action"),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
