...
const fontIdErrorMessage = localize(2048, 'The font ID must only contain letters, numbers, underscores and dashes.');
        ...
        this.iconSchema = {
            definitions: {
                icons: {
                    type: 'object',
                    properties: {
                        fontId: { type: 'string', description: localize(2049, 'The id of the font to use. If not set, the font that is defined first is used.'), pattern: fontIdRegex.source, patternErrorMessage: fontIdErrorMessage },
                        fontCharacter: { type: 'string', description: localize(2050, 'The font character associated with the icon definition.') }
                    },
...
// common icons
const widgetClose = registerIcon('widget-close', Codicon.close, localize(2051, 'Icon for the close action in widgets.'));
registerIcon('goto-previous-location', Codicon.arrowUp, localize(2052, 'Icon for goto previous editor location.'));
registerIcon('goto-next-location', Codicon.arrowDown, localize(2053, 'Icon for goto next editor location.'));
