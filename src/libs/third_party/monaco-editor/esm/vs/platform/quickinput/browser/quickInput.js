...
const InQuickInputContextKey = new RawContextKey(inQuickInputContextKeyValue, false, localize(1769, "Whether keyboard focus is inside the quick input control"));
...
const QuickInputAlignmentContextKey = new RawContextKey(quickInputAlignmentContextKeyValue, 'top', localize(1770, "The alignment of the quick input"));
const quickInputTypeContextKeyValue = 'quickInputType';
const QuickInputTypeContextKey = new RawContextKey(quickInputTypeContextKeyValue, undefined, localize(1771, "The type of the currently visible quick input"));
const endOfQuickInputBoxContextKeyValue = 'cursorAtEndOfQuickInputBox';
const EndOfQuickInputBoxContextKey = new RawContextKey(endOfQuickInputBoxContextKeyValue, false, localize(1772, "Whether the cursor in the quick input is at the end of the input box"));
