...
(function (CompletionItemKinds) {
    ...
    function toLabel(kind) {
        switch (kind) {
            case 0 /* CompletionItemKind.Method */: return localize(738, 'Method');
            case 1 /* CompletionItemKind.Function */: return localize(739, 'Function');
            case 2 /* CompletionItemKind.Constructor */: return localize(740, 'Constructor');
            case 3 /* CompletionItemKind.Field */: return localize(741, 'Field');
            case 4 /* CompletionItemKind.Variable */: return localize(742, 'Variable');
            case 5 /* CompletionItemKind.Class */: return localize(743, 'Class');
            case 6 /* CompletionItemKind.Struct */: return localize(744, 'Struct');
            case 7 /* CompletionItemKind.Interface */: return localize(745, 'Interface');
            case 8 /* CompletionItemKind.Module */: return localize(746, 'Module');
            case 9 /* CompletionItemKind.Property */: return localize(747, 'Property');
            case 10 /* CompletionItemKind.Event */: return localize(748, 'Event');
            case 11 /* CompletionItemKind.Operator */: return localize(749, 'Operator');
            case 12 /* CompletionItemKind.Unit */: return localize(750, 'Unit');
            case 13 /* CompletionItemKind.Value */: return localize(751, 'Value');
            case 14 /* CompletionItemKind.Constant */: return localize(752, 'Constant');
            case 15 /* CompletionItemKind.Enum */: return localize(753, 'Enum');
            case 16 /* CompletionItemKind.EnumMember */: return localize(754, 'Enum Member');
            case 17 /* CompletionItemKind.Keyword */: return localize(755, 'Keyword');
            case 18 /* CompletionItemKind.Text */: return localize(756, 'Text');
            case 19 /* CompletionItemKind.Color */: return localize(757, 'Color');
            case 20 /* CompletionItemKind.File */: return localize(758, 'File');
            case 21 /* CompletionItemKind.Reference */: return localize(759, 'Reference');
            case 22 /* CompletionItemKind.Customcolor */: return localize(760, 'Custom Color');
            case 23 /* CompletionItemKind.Folder */: return localize(761, 'Folder');
            case 24 /* CompletionItemKind.TypeParameter */: return localize(762, 'Type Parameter');
            case 25 /* CompletionItemKind.User */: return localize(763, 'User');
            case 26 /* CompletionItemKind.Issue */: return localize(764, 'Issue');
            case 27 /* CompletionItemKind.Tool */: return localize(765, 'Tool');
            case 28 /* CompletionItemKind.Snippet */: return localize(766, 'Snippet');
            default: return '';
        }
    }
...
const symbolKindNames = {
    [17 /* SymbolKind.Array */]: localize(767, "array"),
    [16 /* SymbolKind.Boolean */]: localize(768, "boolean"),
    [4 /* SymbolKind.Class */]: localize(769, "class"),
    [13 /* SymbolKind.Constant */]: localize(770, "constant"),
    [8 /* SymbolKind.Constructor */]: localize(771, "constructor"),
    [9 /* SymbolKind.Enum */]: localize(772, "enumeration"),
    [21 /* SymbolKind.EnumMember */]: localize(773, "enumeration member"),
    [23 /* SymbolKind.Event */]: localize(774, "event"),
    [7 /* SymbolKind.Field */]: localize(775, "field"),
    [0 /* SymbolKind.File */]: localize(776, "file"),
    [11 /* SymbolKind.Function */]: localize(777, "function"),
    [10 /* SymbolKind.Interface */]: localize(778, "interface"),
    [19 /* SymbolKind.Key */]: localize(779, "key"),
    [5 /* SymbolKind.Method */]: localize(780, "method"),
    [1 /* SymbolKind.Module */]: localize(781, "module"),
    [2 /* SymbolKind.Namespace */]: localize(782, "namespace"),
    [20 /* SymbolKind.Null */]: localize(783, "null"),
    [15 /* SymbolKind.Number */]: localize(784, "number"),
    [18 /* SymbolKind.Object */]: localize(785, "object"),
    [24 /* SymbolKind.Operator */]: localize(786, "operator"),
    [3 /* SymbolKind.Package */]: localize(787, "package"),
    [6 /* SymbolKind.Property */]: localize(788, "property"),
    [14 /* SymbolKind.String */]: localize(789, "string"),
    [22 /* SymbolKind.Struct */]: localize(790, "struct"),
    [25 /* SymbolKind.TypeParameter */]: localize(791, "type parameter"),
    [12 /* SymbolKind.Variable */]: localize(792, "variable"),
};
/**
 * @internal
 */
function getAriaLabelForSymbol(symbolName, kind) {
    return localize(793, '{0} ({1})', symbolName, symbolKindNames[kind]);
}
/**
 * @internal
 */
