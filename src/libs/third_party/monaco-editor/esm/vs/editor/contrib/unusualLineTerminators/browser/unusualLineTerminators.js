    ...
    async _checkForUnusualLineTerminators() {
        ...
        try {
            ...
            result = await this._dialogService.confirm({
                title: localize(1577, "Unusual Line Terminators"),
                message: localize(1578, "Detected unusual line terminators"),
                detail: localize(1579, "The file '{0}' contains one or more unusual line terminator characters, like Line Separator (LS) or Paragraph Separator (PS).\n\nIt is recommended to remove them from the file. This can be configured via `editor.unusualLineTerminators`.", basename(model.uri)),
                primaryButton: localize(1580, "&&Remove Unusual Line Terminators"),
                cancelButton: localize(1581, "Ignore")
            });
        }
        finally {
            this._isPresentingDialog = false;
