...
class TimeBasedVariableResolver {
    ...
    static { this.dayNames = [localize(1423, "Sunday"), localize(1424, "Monday"), localize(1425, "Tuesday"), localize(1426, "Wednesday"), localize(1427, "Thursday"), localize(1428, "Friday"), localize(1429, "Saturday")]; }
    static { this.dayNamesShort = [localize(1430, "Sun"), localize(1431, "Mon"), localize(1432, "Tue"), localize(1433, "Wed"), localize(1434, "Thu"), localize(1435, "Fri"), localize(1436, "Sat")]; }
    static { this.monthNames = [localize(1437, "January"), localize(1438, "February"), localize(1439, "March"), localize(1440, "April"), localize(1441, "May"), localize(1442, "June"), localize(1443, "July"), localize(1444, "August"), localize(1445, "September"), localize(1446, "October"), localize(1447, "November"), localize(1448, "December")]; }
    static { this.monthNamesShort = [localize(1449, "Jan"), localize(1450, "Feb"), localize(1451, "Mar"), localize(1452, "Apr"), localize(1453, "May"), localize(1454, "Jun"), localize(1455, "Jul"), localize(1456, "Aug"), localize(1457, "Sep"), localize(1458, "Oct"), localize(1459, "Nov"), localize(1460, "Dec")]; }
    resolve(variable) {
        const { name } = variable;
