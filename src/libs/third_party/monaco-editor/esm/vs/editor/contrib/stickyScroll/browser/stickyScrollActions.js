...
class ToggleStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1465, "Toggle Editor Sticky Scroll"),
                mnemonicTitle: localize(1461, "&&Toggle Editor Sticky Scroll"),
            },
            metadata: {
                description: localize2(1466, "Toggle/enable the editor sticky scroll which shows the nested scopes at the top of the viewport"),
            },
            category: Categories.View,
            toggled: {
                condition: ContextKeyExpr.equals('config.editor.stickyScroll.enabled', true),
                title: localize(1462, "Sticky Scroll"),
                mnemonicTitle: localize(1463, "&&Sticky Scroll"),
            },
            menu: [
...
class FocusStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1467, "Focus Editor Sticky Scroll"),
                mnemonicTitle: localize(1464, "&&Focus Editor Sticky Scroll"),
            },
...
class SelectNextStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1468, "Select the next editor sticky scroll line"),
...
class SelectPreviousStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1469, "Select the previous sticky scroll line"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
...
class GoToStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1470, "Go to the focused sticky scroll line"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
...
class SelectEditor extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1471, "Select Editor"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
