...
let AbstractGotoSymbolQuickAccessProvider = class AbstractGotoSymbolQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
    ...
    provideWithoutTextEditor(picker) {
        this.provideLabelPick(picker, localize(1362, "To go to a symbol, first open a text editor with symbol information."));
    ...
    doProvideWithoutEditorSymbols(context, model, picker, token) {
        ...
        this.provideLabelPick(picker, localize(1363, "The active text editor does not provide symbol information."));
            ...
            try {
                ...
                if (items.length > 0) {
                    ...
                    if (query.original.length > 0) {
                        this.provideLabelPick(picker, localize(1364, "No matching editor symbols"));
                    }
                    else {
                        this.provideLabelPick(picker, localize(1365, "No editor symbols"));
                    }
                }
            }
            finally {
    ...
    async doGetSymbolPicks(symbolsPromise, query, options, token, model) {
        ...
        if (openSideBySideDirection) {
            buttons = [{
                    ...
                    tooltip: openSideBySideDirection === 'right' ? localize(1366, "Open to the Side") : localize(1367, "Open to the Bottom")
                }];
        }
        ...
        if (filterBySymbolKind) {
            ...
            symbolPicks = [
                { label: localize(1368, "symbols ({0})", filteredSymbolPicks.length), type: 'separator' },
...
// #region NLS Helpers
const FALLBACK_NLS_SYMBOL_KIND = localize(1369, "properties ({0})");
const NLS_SYMBOL_KIND_CACHE = {
    [5 /* SymbolKind.Method */]: localize(1370, "methods ({0})"),
    [11 /* SymbolKind.Function */]: localize(1371, "functions ({0})"),
    [8 /* SymbolKind.Constructor */]: localize(1372, "constructors ({0})"),
    [12 /* SymbolKind.Variable */]: localize(1373, "variables ({0})"),
    [4 /* SymbolKind.Class */]: localize(1374, "classes ({0})"),
    [22 /* SymbolKind.Struct */]: localize(1375, "structs ({0})"),
    [23 /* SymbolKind.Event */]: localize(1376, "events ({0})"),
    [24 /* SymbolKind.Operator */]: localize(1377, "operators ({0})"),
    [10 /* SymbolKind.Interface */]: localize(1378, "interfaces ({0})"),
    [2 /* SymbolKind.Namespace */]: localize(1379, "namespaces ({0})"),
    [3 /* SymbolKind.Package */]: localize(1380, "packages ({0})"),
    [25 /* SymbolKind.TypeParameter */]: localize(1381, "type parameters ({0})"),
    [1 /* SymbolKind.Module */]: localize(1382, "modules ({0})"),
    [6 /* SymbolKind.Property */]: localize(1383, "properties ({0})"),
    [9 /* SymbolKind.Enum */]: localize(1384, "enumerations ({0})"),
    [21 /* SymbolKind.EnumMember */]: localize(1385, "enumeration members ({0})"),
    [14 /* SymbolKind.String */]: localize(1386, "strings ({0})"),
    [0 /* SymbolKind.File */]: localize(1387, "files ({0})"),
    [17 /* SymbolKind.Array */]: localize(1388, "arrays ({0})"),
    [15 /* SymbolKind.Number */]: localize(1389, "numbers ({0})"),
    [16 /* SymbolKind.Boolean */]: localize(1390, "booleans ({0})"),
    [18 /* SymbolKind.Object */]: localize(1391, "objects ({0})"),
    [19 /* SymbolKind.Key */]: localize(1392, "keys ({0})"),
    [7 /* SymbolKind.Field */]: localize(1393, "fields ({0})"),
    [13 /* SymbolKind.Constant */]: localize(1394, "constants ({0})")
};
//#endregion
