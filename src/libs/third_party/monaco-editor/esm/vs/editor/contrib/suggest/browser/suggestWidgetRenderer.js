...
const suggestMoreInfoIcon = registerIcon('suggest-more-info', Codicon.chevronRight, localize(1511, 'Icon for more information in the suggest widget.'));
...
let ItemRenderer = class ItemRenderer {
    ...
    renderTemplate(container) {
        ...
        readMore.title = localize(1512, "Read More");
        const configureFont = () => {
