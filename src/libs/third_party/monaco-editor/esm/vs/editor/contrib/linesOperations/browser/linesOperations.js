...
class CopyLinesUpAction extends AbstractCopyLinesAction {
    constructor() {
        super(false, {
            ...
            label: localize2(1263, "Copy Line Up"),
...
class CopyLinesDownAction extends AbstractCopyLinesAction {
    constructor() {
        super(true, {
            ...
            label: localize2(1264, "Copy Line Down"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: localize(1259, "Co&&py Line Down"),
                order: 2
            },
            canTriggerInlineEdits: true,
        });
...
class DuplicateSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1265, "Duplicate Selection"),
            precondition: EditorContextKeys.writable,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: localize(1260, "&&Duplicate Selection"),
                order: 5
            },
            canTriggerInlineEdits: true,
        });
...
class MoveLinesUpAction extends AbstractMoveLinesAction {
    constructor() {
        super(false, {
            ...
            label: localize2(1266, "Move Line Up"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: localize(1261, "Mo&&ve Line Up"),
                order: 3
            },
            canTriggerInlineEdits: true,
        });
...
class MoveLinesDownAction extends AbstractMoveLinesAction {
    constructor() {
        super(true, {
            ...
            label: localize2(1267, "Move Line Down"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: localize(1262, "Move &&Line Down"),
                order: 4
            },
            canTriggerInlineEdits: true,
        });
...
class SortLinesAscendingAction extends AbstractSortLinesAction {
    constructor() {
        super(false, {
            ...
            label: localize2(1268, "Sort Lines Ascending"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
class SortLinesDescendingAction extends AbstractSortLinesAction {
    constructor() {
        super(true, {
            ...
            label: localize2(1269, "Sort Lines Descending"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
class DeleteDuplicateLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1270, "Delete Duplicate Lines"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
class ReverseLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1271, "Reverse lines"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class TrimTrailingWhitespaceAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: localize2(1272, "Trim Trailing Whitespace"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class DeleteLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1273, "Delete Line"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
...
class IndentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1274, "Indent Line"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class OutdentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1275, "Outdent Line"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class InsertLineBeforeAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: localize2(1276, "Insert Line Above"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class InsertLineAfterAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: localize2(1277, "Insert Line Below"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class DeleteAllLeftAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllLeft',
            label: localize2(1278, "Delete All Left"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
...
class DeleteAllRightAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllRight',
            label: localize2(1279, "Delete All Right"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
...
class JoinLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1280, "Join Lines"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: 0,
...
class TransposeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1281, "Transpose Characters around the Cursor"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
class UpperCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: localize2(1282, "Transform to Uppercase"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
class LowerCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: localize2(1283, "Transform to Lowercase"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class TitleCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: localize2(1284, "Transform to Title Case"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class SnakeCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: localize2(1285, "Transform to Snake Case"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
class CamelCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: localize2(1286, "Transform to Camel Case"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
class PascalCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: localize2(1287, "Transform to Pascal Case"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
class KebabCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: localize2(1288, 'Transform to Kebab Case'),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
