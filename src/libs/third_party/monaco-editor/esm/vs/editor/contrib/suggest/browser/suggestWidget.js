 ...
 */
registerColor('editorSuggestWidget.background', editorWidgetBackground, localize(1492, 'Background color of the suggest widget.'));
registerColor('editorSuggestWidget.border', editorWidgetBorder, localize(1493, 'Border color of the suggest widget.'));
const editorSuggestWidgetForeground = registerColor('editorSuggestWidget.foreground', editorForeground, localize(1494, 'Foreground color of the suggest widget.'));
registerColor('editorSuggestWidget.selectedForeground', quickInputListFocusForeground, localize(1495, 'Foreground color of the selected entry in the suggest widget.'));
registerColor('editorSuggestWidget.selectedIconForeground', quickInputListFocusIconForeground, localize(1496, 'Icon foreground color of the selected entry in the suggest widget.'));
const editorSuggestWidgetSelectedBackground = registerColor('editorSuggestWidget.selectedBackground', quickInputListFocusBackground, localize(1497, 'Background color of the selected entry in the suggest widget.'));
registerColor('editorSuggestWidget.highlightForeground', listHighlightForeground, localize(1498, 'Color of the match highlights in the suggest widget.'));
registerColor('editorSuggestWidget.focusHighlightForeground', listFocusHighlightForeground, localize(1499, 'Color of the match highlights in the suggest widget when an item is focused.'));
registerColor('editorSuggestWidgetStatus.foreground', transparent(editorSuggestWidgetForeground, .5), localize(1500, 'Foreground color of the suggest widget status.'));
...
let SuggestWidget = class SuggestWidget {
    ...
    static { this.LOADING_MESSAGE = localize(1501, "Loading..."); }
    static { this.NO_SUGGESTIONS_MESSAGE = localize(1502, "No suggestions."); }
    constructor(editor, _storageService, _contextKeyService, _themeService, instantiationService) {
        ...
        this._list = new List('SuggestWidget', this._listElement, {
            ...
            accessibilityProvider: {
                ...
                getWidgetAriaLabel: () => localize(1503, "Suggest"),
                ...
                getAriaLabel: (item) => {
                    ...
                    if (typeof item.completion.label !== 'string') {
                        ...
                        if (detail && description) {
                            label = localize(1504, '{0} {1}, {2}, {3}', label, detail, description, kindLabel);
                        }
                        else if (detail) {
                            label = localize(1505, '{0} {1}, {2}', label, detail, kindLabel);
                        }
                        else if (description) {
                            label = localize(1506, '{0}, {1}, {2}', label, description, kindLabel);
                        }
                    }
                    else {
                        label = localize(1507, '{0}, {1}', label, kindLabel);
                    }
                    ...
                    return localize(1508, "{0}, docs: {1}", label, docs);
                },
            }
        });
