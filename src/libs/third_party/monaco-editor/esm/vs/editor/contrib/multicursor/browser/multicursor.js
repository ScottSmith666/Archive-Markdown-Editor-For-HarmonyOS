...
function announceCursorChange(previousCursorState, cursorState) {
    ...
    if (cursorDiff.length >= 1) {
        ...
        const msg = cursorDiff.length === 1 ? localize(1302, "Cursor added: {0}", cursorPositions) : localize(1303, "Cursors added: {0}", cursorPositions);
        status(msg);
    }
}
class InsertCursorAbove extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1312, "Add Cursor Above"),
            ...
            menuOpts: {
                ...
                group: '3_multi',
                title: localize(1304, "&&Add Cursor Above"),
                order: 2
            }
        });
    }
...
class InsertCursorBelow extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1313, "Add Cursor Below"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class InsertCursorAtEndOfEachLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1314, "Add Cursors to Line Ends"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: localize(1306, "Add C&&ursors to Line Ends"),
                order: 4
            }
        });
    }
...
class InsertCursorAtEndOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1315, "Add Cursors to Bottom"),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
class InsertCursorAtTopOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1316, "Add Cursors to Top"),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
class AddSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: localize2(1317, "Add Selection to Next Find Match"),
            precondition: undefined,
            kbOpts: {
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: localize(1307, "Add &&Next Occurrence"),
                order: 5
            }
        });
    }
...
class AddSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: localize2(1318, "Add Selection to Previous Find Match"),
            precondition: undefined,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: localize(1308, "Add P&&revious Occurrence"),
                order: 6
            }
        });
    }
...
class MoveSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: localize2(1319, "Move Last Selection to Next Find Match"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
class MoveSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: localize2(1320, "Move Last Selection to Previous Find Match"),
            precondition: undefined
        });
    }
    _run(multiCursorController, findController) {
...
class SelectHighlightsAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: localize2(1321, "Select All Occurrences of Find Match"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: localize(1309, "Select All &&Occurrences"),
                order: 7
            }
        });
    }
...
class CompatChangeAll extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: localize2(1322, "Change All Occurrences"),
...
class FocusNextCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1323, "Focus Next Cursor"),
            metadata: {
                description: localize(1310, "Focuses the next cursor"),
                args: [],
            },
            precondition: undefined
        });
...
class FocusPreviousCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1324, "Focus Previous Cursor"),
            metadata: {
                description: localize(1311, "Focuses the previous cursor"),
                args: [],
            },
            precondition: undefined
        });
